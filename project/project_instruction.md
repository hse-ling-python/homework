...
**Важно:** финальный проект -- это экзамен по этому курсу, то есть последний элемент контроля. Вес проекта -- 2 балла от итоговой оценки за курс. Проект -- индивидуальное задание. Вы можете выбрать один из шаюлонов из таблички внизу, можете предложить свою тему. Один шаблон могут выбрать несколько человек, но варьирующие элементы шаблона должны быть у каждого свои.
...
- до 11 мая -- выбрать тему и вписать её в табличку. **Свою тему нужно будет вписать вот в эту табличку.**
