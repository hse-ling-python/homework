...
Данные, которые будут вводиться в анкету, должны записываться в базу данных. В базе данных должно быть три таблицы: (1) таблица с полученными лингвистическими данными; (2) таблица с информацией об информанте (имя/возраст/город проживания/родной язык/гендер и т.п.); (3) таблица, сопоставляющая id ответа из первой таблицы id информанта из второй таблицы.
...
|1|Меню: ссылки/переходы между страницами.|
|2|Страница опроса, на которой показывается анкета с полями.|
|2|Данные из анкеты сохраняются в базу данных. Три таблицы: (1) таблица с полученными лингвистическими данными; (2) таблица с информацией об информанте (имя/возраст/город проживания/родной язык/гендер и т.п.); (3) таблица, сопоставляющая id ответа из первой таблицы id информанта из второй таблицы.|
